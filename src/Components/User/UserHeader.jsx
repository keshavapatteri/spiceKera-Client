        ...
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center space-x-2">
            ...
            <motion.button
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="ml-4 px-4 py-2 rounded-full bg-gradient-to-r from-red-500 to-orange-500 text-white text-sm font-medium shadow-md hover:shadow-lg transition-all"
            >
              Logout
            </motion.button>
          </nav>
          ...
          >
            <div className="px-2 pt-2 pb-4 space-y-1 sm:px-3">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="w-full mt-2 px-4 py-3 rounded-md bg-gradient-to-r from-red-500 to-orange-500 text-white font-medium shadow-md"
              >
                Logout
              </motion.button>
            </div>
